...
SCREEN_PARSING_USER_PROMPT = """The resolution of the screenshot is {resolution} pixels. Please generate the JSON array of control information objects as specified here:
