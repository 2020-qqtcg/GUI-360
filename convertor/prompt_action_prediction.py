...
ACTION_PREDICTION_USER_PROMPT_QWEN_A11Y = """You are a helpful assistant with accessibility support. Given a screenshot of the current screen, accessibility (a11y) information with control labels, user instruction and history of actions, you need to decide the next action to take.
